const DATA = [
    ...
    {
        title: 'Майбутнє починається з вибору',
        description: 'Мотиваційне відео для дев’ятикласників про вибір подальшого навчання та майбутньої професії. Воно допомагає замислитися над відповідальністю за власне майбутнє та важливістю усвідомленого рішення.',
        url: 'https://drive.google.com/file/d/1rRrjJ7j5Zw9GgPIYA5kPIdXwdnv-qn-y/view?usp=sharing',
        cover: 'images/Профорієнтація.jpeg'
    },
    {
