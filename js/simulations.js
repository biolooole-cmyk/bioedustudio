const DATA = [
    ...
    },
    {
        ...
        description: 'Інтерактивне середовище дозволяє створювати ланцюги живлення та сітки живлення, поєднуючи організми різних трофічних рівнів і відстежуючи потоки енергії між ними, а також змінювати параметри середовища, такі як температура, вологість, освітлення та стан ґрунту, щоб досліджувати їхній вплив на виживання, взаємодію та баланс між видами, аналізувати зміни чисельності організмів і краще розуміти закономірності функціонування природних систем.',
        url: 'https://eco-weave-sim.lovable.app',
        cover: 'images/Живлення.png'
    },
    {
        title: 'Гомеостаз глюкози в крові',
        description: 'Модель механізму підтримання стабільної концентрації цукру. Вона демонструє роль гормонів у регуляції обміну речовин.',
        url: 'https://glucose-flow-explorer.lovable.app',
        cover: 'images/Глюкоза.jpeg'
    },
      {
        title: 'BioSolve Lab',
        description: 'Інтерактивна платформа містить набір задач з молекулярної біології, що охоплюють теми від комплементарності ДНК до транскрипції та мутацій, дозволяє обирати рівень складності, фільтрувати завдання за темами, поступово перевіряти свої знання та відпрацьовувати навички розв’язання біологічних задач у структурованому форматі.',
        url: 'https://bio-quest-shuffle.lovable.app',
        cover: 'images/Задачі молекулярна.png'
    },
    {
        title: 'Епідемія в місті',
        description: 'Симуляція поширення інфекційних захворювань у популяції, яка демонструє динаміку епідеміологічних процесів. Моделює вплив різних факторів: швидкості передачі інфекції, рівня імунітету населення, ефективності карантинних заходів та вакцинації. Дозволяє досліджувати як математичні моделі можуть прогнозувати розвиток епідемій та оцінювати ефективність різних стратегій запобігання поширенню хвороб. Розвиває системне мислення та розуміння взаємовідношень між біологічними, соціальними та математичними аспектами епідеміології.',
        url: 'https://websim.com/p/lf0mseqavivina_ji8fs',
        cover: 'images/Епідемія в місті.jpeg'
    },
    {
        title: 'Життєва ємність легень та газообмін',
        description: 'Модель яка відтворює процес потрапляння кисню до організму та видалення вуглекислого газу. Вона демонструє як рухи грудної клітки забезпечують вентиляцію легень і сприяють газообміну.',
        url: 'https://light-lung-bloom.lovable.app',
        cover: 'images/Легені.jpeg'
    },
    {
        title: 'Симуляція клітинного поділу',
        description: 'Симуляція процесу клітинного поділу. Модель демонструє основні етапи розподілу хромосом і формування нових клітин.',
        url: 'https://cell-voyage-ukraine.lovable.app',
        cover: 'images/Мітоз.jpeg'
    },
    {
    ...
    {
        title: 'ЦНС симулятор',
        description: 'Інтерактивна модель що відтворює структуру мозку та функції його відділів. Вона допомагає усвідомити роль кожної частини у забезпеченні мислення рухів пам’яті та життєво важливих реакцій.',
        url: 'https://brain-bright-explore.lovable.app',
        cover: 'images/Мозок.jpeg'
    },
    {
        title: 'Нефрон: фільтрація та утворення сечі',
        description: 'Модель функціонування нефрону у процесі очищення крові. Вона відображає основні етапи формування вторинної сечі в нефроні.',
        url: 'https://nephron-journey.lovable.app',
        cover: 'images/Нефрон.jpeg'
    },
    {
     ...
     {
        title: 'Повна модель екосистеми',
        description: 'Інтерактивна STEM-симуляція «Повна модель екосистеми» демонструє взаємодію рослин, травоїдних, хижаків і мікроорганізмів у природній системі. Користувач може змінювати параметри екосистеми, запускати різні сценарії та спостерігати, як змінюється чисельність популяцій і баланс трофічних рівнів. Симуляція призначена для навчання екології в школі, підготовки до НМТ та базових університетських курсів.',
        url: 'https://life-cycle-lab.lovable.app',
        cover: 'images/Екосистема.png'
    },
      {
        title: 'Життєвий цикл гельмінтів',
        description: 'Симуляція демонструє життєві цикли різних паразитичних гельмінтів із покроковою візуалізацією розвитку, шляхів зараження та переміщення в організмі людини, а також надає довідкову інформацію про кожен вид і показує ефективні заходи профілактики.',
        url: 'https://life-cycle-explorer-ukr.lovable.app',
        cover: 'images/Черви.png'
    },
     {
        title: 'Автономна нервова система',
        description: 'Симуляція що демонструє автоматичну регуляцію роботи внутрішніх органів. Вона пояснює взаємодію відділів нервової системи під час стресу та відпочинку.',
        url: 'https://balance-of-life-sim.lovable.app',
        cover: 'images/Автономна.jpeg'
    },
    {
        title: 'Рефлекторна дуга',
        description: 'Модель швидкої реакції організму на подразнення. Вона відображає послідовність передачі нервового сигналу від рецептора до виконавчого органа.',
        url: 'https://reflex-arc-lab.lovable.app',
        cover: 'images/Дуга.jpeg'
    },
    {
        title: 'Штучний добір',
        description: 'Модель процесу у якому людина самостійно відбирає організми з потрібними характеристиками для розмноження. Симуляція відображає зміну спадкових ознак у популяції під контролем людини.',
        url: 'https://gene-garden-wizard.lovable.app',
        cover: 'images/Селекція.jpeg'
    },
    {
     ...
     {
        title: 'Нефрон',
        description: 'Інтерактивна 3D-симуляція функціонування нефрона демонструє процеси утворення сечі в нирках людини на клітинно-тканинному рівні. Модель відображає клубочкову фільтрацію, канальцеву реабсорбцію, секрецію та формування вторинної сечі з візуалізацією руху частинок речовин. Симуляція дозволяє змінювати фізіологічні параметри, досліджувати гормональну регуляцію водно-сольового балансу та моделювати патологічні стани нирок у навчальних цілях для учнів 8–11 класів.',
        url: 'https://nephro-flow-lab.lovable.app',
        cover: 'images/Нирка.png'
    },
     {
        title: 'Згортування крові',
        description: 'Віртуальна симуляція відтворює процес гемостазу, демонструючи поетапне згортання крові від моменту пошкодження судини до формування стабільного фібринового згустка, надає можливість змінювати ключові параметри, обирати різні сценарії та аналізувати їхній вплив на перебіг і ефективність зупинки кровотечі.',
        url: 'https://clot-compass.lovable.app',
        cover: 'images/Згортування.png'
    },
    {
    ...
    {
        title: 'Будова та функції шкіри людини',
        description: 'Інтерактивна STEM-симуляція «Будова шкіри, терморегуляція, опіки та хвороби шкіри» призначена для вивчення будови шкіри та основних процесів, що відбуваються в ній. Модель демонструє шари шкіри, клітинну будову, механізми терморегуляції, а також дозволяє досліджувати різні ступені опіків і поширені захворювання шкіри. Симуляція поєднує науково коректну візуалізацію та інтерактивну взаємодію для кращого розуміння функцій шкіри.',
        url: 'https://skin-lab-ukraine.lovable.app',
        cover: 'images/Шкіра.png'
    },
    {
    ...
    {
        title: 'Клітинний метаболізм',
        description: 'Симуляція що показує співвідношення між отриманою з їжі енергією та її витратами. Вона пояснює механізм регуляції маси тіла залежно від способу життя.',
        url: 'https://cell-spark-flow.lovable.app/',
        cover: 'images/Мітохондрія.jpeg'
    },
    {
        title: 'Симуляція дихальної системи людини',
        description: 'Модель що ілюструє процес надходження кисню та виведення вуглекислого газу. Вона пояснює взаємозв’язок між рухами грудної клітки та газообміном у легенях.',
        url: 'https://breath-deep-analyze.lovable.app',
        cover: 'images/Дихання.jpeg'
    },
     {
    ...
    {
        title: 'Модифікаційна мінливість',
        description: 'Інтерактивна симуляція модифікаційної мінливості демонструє вплив факторів середовища на фенотип рослин і тварин без зміни генотипу. Користувач змінює умови середовища, спостерігає зміни ознак, формує варіаційний ряд, будує варіаційну криву та аналізує норму реакції. Симуляція містить теорію, статистичний аналіз і міні тест.',
        url: 'https://pheno-play-lab.lovable.app',
        cover: 'images/Фенотип.jpeg'
    },
    {
    ...
    },
    {
        ...
        description: 'Інтерактивна модель демонструє основні екологічні закони через вплив факторів середовища на ріст популяції, дозволяє змінювати параметри, такі як температура, світло, вода та поживні речовини, визначати лімітуючий фактор, аналізувати динаміку росту за графіками та оцінювати ефективність розвитку залежно від умов середовища.',
        url: 'https://https://life-laws-play.lovable.app',
        cover: 'images/Екологічні закони.png'
    },
    {
    ...
    },
     {
        ...
        description: 'Інтерактивна симуляція імунної системи людини це освітнє вебсередовище, що в реальному часі демонструє захист організму від інфекцій. Користувач спостерігає проникнення патогенів, активує імунні клітини, проводить вакцинацію та моделює повторне зараження. Симуляція наочно показує роботу вродженого та адаптивного імунітету, утворення антитіл і формування імунної пам’яті, поєднуючи наукову точність із зрозумілою сучасною візуалізацією.',
        url: 'https://biolooole-cmyk.github.io/bioedustudio/',
        cover: 'images/Імунітет.jpeg'
    },
    {
    ...
    {
        title: 'Будова слухового аналізатора',
        description: 'Симуляція демонструє процес сприйняття звуку людиною через поетапну візуалізацію проходження звукової хвилі від зовнішнього вуха до внутрішнього, включаючи коливання барабанної перетинки, передачу через слухові кісточки, рух рідини у завитці та перетворення сигналу на нервовий імпульс, а також дозволяє змінювати параметри звуку й спостерігати вплив різних порушень слуху на цей процес.',
        url: 'https://pelajaran-3d.lovable.app',
        cover: 'images/Вухо.png'
    },
    {
        title: 'Плантагочи',
    ...
    {
        title: 'Фотосинтез. Інтерактивна симуляція',
        description: 'Інтерактивна STEM-симуляція «Фотосинтез» демонструє механізм фотосинтезу на клітинному та молекулярному рівнях. Модель відтворює будову хлоропласта та основні етапи процесу: світлову фазу реакцій і цикл Кальвіна. Користувач може змінювати інтенсивність світла, концентрацію CO₂, температуру та спостерігати вплив цих факторів на швидкість фотосинтезу. Симуляція призначена для уроків біології у 9–11 класах і підготовки до НМТ.',
        url: 'https://chloro-flow-lab.lovable.app',
        cover: 'images/Хлоропласт.png'
    },
      {
        title: 'Око людини',
        description: 'Модель дозволяє дослідити, як формується зображення в оці людини через проходження світла, його фокусування на сітківці та перетворення на нервові сигнали, а також дає можливість змінювати параметри, аналізувати різні порушення зору й спостерігати їхній вплив на сприйняття та активність рецепторів.',
        url: 'https://vision-lab-interactive.lovable.app',
        cover: 'images/Око.png'
    },
    {
        title: 'Ланцюги живлення',
